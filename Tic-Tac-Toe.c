...
void computerplay()
{
	...
	{
		sleep(2);
		printf("\n Computer have placed \"O\" on position : ");
...
int main()
{
	...
	{
		drow = 1;
		dai1 = 1, dai2 = 1, ver1 = 1, ver2 = 1, ver3 = 1, hor1 = 1, hor2 = 1, hor3 = 1;
		for(l=0; l<9; l++)
			xo[0][l] = 49+l;
